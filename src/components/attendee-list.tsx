          ...
          <tbody>
            {Array.from({ length: 5 }).map((_, i) => {
              ...
              <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                ...
                <td className="py-3 px-4 text-sm text-zinc-300">
                  <button className="bg-black/20 border border-white/10 rounded-md p-1.5 hover:border-orange-400">
              ...
              <td className="py-3 px-4 text-sm text-zinc-300 text-right" colSpan={3}>
                <div className="inline-flex items-center gap-8">
                  ...
                  <div className="flex gap-1.5">
                    <button className="bg-white/5 border border-white/10 rounded-md p-1.5 disabled:cursor-not-allowed enabled:hover:border-orange-400" disabled>
                    ...
                    <button className="bg-white/20 border border-white/10 rounded-md p-1.5 disabled:cursor-not-allowed enabled:hover:border-orange-400">
